...
namespace Discord.Rest
{
    internal static class ChannelHelper
    {
        ...
        public static async Task<RestUserMessage> SendMessageAsync(IMessageChannel channel, BaseDiscordClient client,
            string text, bool isTTS, Embed[] embeds, AllowedMentions allowedMentions, MessageReference messageReference, MessageComponent component, RequestOptions options, Embed embed = null)
        {
